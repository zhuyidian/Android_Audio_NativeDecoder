...
jint Java_com_mediatek_factorymode_NativeMP3Decoder_initAudioPlayer(JNIEnv *env, jobject obj, jstring file,jint startAddr)
{
 ...
 jint Java_com_mediatek_factorymode_NativeMP3Decoder_getAudioBuf(JNIEnv *env, jobject obj ,jshortArray audioBuf,jint len)
{
 ...
 jint Java_com_mediatek_factorymode_NativeMP3Decoder_getAudioSamplerate(JNIEnv *env, jobject obj)
{
 ...
 void Java_com_mediatek_factorymode_NativeMP3Decoder_closeAduioFile(JNIEnv *env, jobject obj)
